...
export const IBaseEntitySchema = t.Composite(
  [
    ...
    t.Object({
      ...
      persons: t.Array(t.Union([IPersonSchema, t.String(), IDocumentSchema])),
...
export const IDigitalEntitySchema = t.Composite(
  [
    ...
    t.Object({
      ...
      tags: t.Array(t.Union([ITagSchema, IDocumentSchema])),
      dimensions: t.Array(IDimensionTupleSchema),
      creation: t.Array(ICreationTupleSchema),
      files: t.Array(IFileSchema),
      statement: t.String(),
      objecttype: t.String(),
      phyObjs: t.Array(t.Union([IPhysicalEntitySchema, IDocumentSchema])),
    }),
  ],
  {
    description:
...
export const IEntitySchema = t.Composite(
  [
    ...
    t.Object({
      ...
      relatedDigitalEntity: t.Union([IDigitalEntitySchema, IDocumentSchema]),
...
export const ICompilationSchema = t.Composite(
  [
    ...
    t.Object({
      ...
      description: t.String(),
      creator: CreatorFieldSchema,
      entities: t.Record(t.String(), t.Union([IEntitySchema, IDocumentSchema])),
      access: AccessFieldSchema,
